        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2rem; margin-bottom: 3rem;">
            ...
            <div>
                ...
                <div style="margin-bottom: 2rem;">
                    <h2 style="font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: #0f172a;">
                ...
                <div class="card" style="padding: 2rem; margin-bottom: 2rem;">
                    <div style="display: flex; justify-content: between; align-items: center; margin-bottom: 1.5rem;">
                        <h2 style="font-size: 1.5rem; font-weight: 600; margin: 0; color: #0f172a;">
            ...
            <div>
                ...
                <div class="card" style="padding: 1.5rem; margin-bottom: 2rem;">
                    ...
                    <div style="display: grid; gap: 0.75rem;">
                        ...
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('watchlist'))); ?>" class="btn btn-outline" style="justify-content: center;">
                ...
                <div class="card" style="padding: 1.5rem; margin-bottom: 2rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        ...
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('watchlist'))); ?>" style="color: #059669; font-size: 0.875rem; text-decoration: none;">
                ...
                <div class="card" style="padding: 1.5rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        ...
                        <a href="<?php echo esc_url(get_permalink(get_page_by_path('news'))); ?>" style="color: #059669; font-size: 0.875rem; text-decoration: none;">
                            <?php _e('View All', 'retail-trade-scanner'); ?>
                        </a>
                    </div>
                    <div id="news-preview">
            ...
            if (container) {
                ...
                container.innerHTML = `
                    <div class="card" style="padding: 1.5rem; text-align: center;">
                        <div style="color: #64748b; font-size: 0.875rem; margin-bottom: 0.5rem;">Total Tracked</div>
                        <div style="font-size: 2rem; font-weight: bold; color: #0f172a;">${marketData.total_stocks.toLocaleString()}</div>
                    </div>
                    <div class="card" style="padding: 1.5rem; text-align: center;">
                        <div style="color: #64748b; font-size: 0.875rem; margin-bottom: 0.5rem;">Gainers</div>
                        <div style="font-size: 2rem; font-weight: bold; color: #059669;">${marketData.gainers.toLocaleString()}</div>
                    </div>
                    <div class="card" style="padding: 1.5rem; text-align: center;">
                        <div style="color: #64748b; font-size: 0.875rem; margin-bottom: 0.5rem;">Losers</div>
                        <div style="font-size: 2rem; font-weight: bold; color: #dc2626;">${marketData.losers.toLocaleString()}</div>
                    </div>
                `;
            }
        })
...
function loadPortfolioSummary() {
    fetch('<?php echo esc_url(rest_url('retail-trade-scanner/v1/proxy/portfolio')); ?>')
        .then(response => response.json())
        .then(data => {
            const container = document.getElementById('portfolio-summary');
            if (container) {
                // Mock portfolio data if API returns empty
                ...
                container.innerHTML = `
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                        <div style="text-align: center;">
                            <div style="color: #64748b; font-size: 0.875rem; margin-bottom: 0.5rem;">Total Value</div>
                            <div style="font-size: 2rem; font-weight: bold; color: #0f172a;">$${totalValue.toLocaleString()}</div>
                        </div>
                        <div style="text-align: center;">
                            <div style="color: #64748b; font-size: 0.875rem; margin-bottom: 0.5rem;">Performance</div>
                            <div style="font-size: 2rem; font-weight: bold; color: ${avgGainLoss >= 0 ? '#059669' : '#dc2626'};">
                        ...
                        ${portfolioData.slice(0, 3).map(item => `
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.75rem; background: #f8fafc; border-radius: 6px;">
                                <div>
                                    ...
                                    <div style="font-size: 0.875rem; color: #64748b;">${item.shares} shares</div>
                                </div>
                                <div style="text-align: right;">
                                    <div style="font-weight: 600;">$${item.current_price}</div>
                                    <div style="font-size: 0.875rem; color: ${item.gain_loss_percent >= 0 ? '#059669' : '#dc2626'};">
        ...
        container.innerHTML = watchlistData.map(item => `
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid #f1f5f9;">
                ...
                <div style="text-align: right;">
                    ...
                    <div style="font-size: 0.75rem; color: ${item.change_percent >= 0 ? '#059669' : '#dc2626'};">
    ...
    if (container) {
        ...
        container.innerHTML = newsData.map(item => `
            <div style="padding: 0.75rem 0; border-bottom: 1px solid #f1f5f9;">
                ...
                <div style="font-size: 0.75rem; color: #64748b;">${item.time}</div>
            </div>
        `).join('');
    }
}
...
function loadRecentActivity() {
    ...
    if (container) {
        ...
        container.innerHTML = activities.map(item => `
            <div style="display: flex; align-items: center; gap: 1rem; padding: 1rem; border: 1px solid #e5e7eb; border-radius: 8px; margin-bottom: 0.75rem;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.875rem; color: #64748b;">${item.time}</div>
                </div>
            </div>
        `).join('');
    }

<?php
/**
 * Template for Contact page - Simplified version
    ...
    <section style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: white; padding: 6rem 0; text-align: center;">
        <div class="container">
            ...
            <p style="font-size: 1.25rem; color: #cbd5e1; max-width: 600px; margin: 0 auto;">
                <?php _e('Have questions about our platform? Need technical support? We are here to help.', 'retail-trade-scanner'); ?>
            </p>
        </div>
    </section>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: start;">
                ...
                <div>
                    <div style="margin-bottom: 3rem;">
                        <h2 style="font-size: 2rem; font-weight: bold; margin-bottom: 1rem; color: #0f172a;">
                            <?php _e('Contact Information', 'retail-trade-scanner'); ?>
                        </h2>
                        <p style="color: #64748b; margin-bottom: 2rem;">
                            <?php _e('Get in touch with our support team for assistance.', 'retail-trade-scanner'); ?>
                        </p>
                    </div>
                            ...
                            <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
                                ...
                                <div>
                                    <h3 style="font-size: 1.25rem; font-weight: 600; margin: 0; color: #0f172a;">
                                        <?php _e('Technical Support', 'retail-trade-scanner'); ?>
                                    </h3>
                                    <p style="color: #64748b; margin: 0; font-size: 0.875rem;">
                                        <?php _e('Technical issues and API questions', 'retail-trade-scanner'); ?>
                                    </p>
                                </div>
                            </div>
                            <p style="color: #64748b; margin-bottom: 1rem; font-size: 0.875rem;">
                                <?php _e('Response within 24 hours', 'retail-trade-scanner'); ?>
                            </p>
                            <a href="mailto:admin@retailtradescanner.com" class="btn btn-outline" style="font-size: 0.875rem;">
